...
export default function MyCarousel() {
  ...
  return (
    ...
    <div className="carousel-body absolute top-0 bottom-0 start-0 flex flex-row transition-transform duration-700 opacity-100" ref={carouselRef}>
      <div className="carousel-slide w-full h-full object-cover flex-none active relative">
      ...
      <div className="carousel-slide w-full h-full object-cover flex-none relative">
